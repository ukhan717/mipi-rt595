...
#define DMB_DISPLAY 5 /* NXP "RK055MHD091A0-CTG MIPI Rectangular Display  */
...
#define DEMO_PANEL_WIDTH  240U
#define DEMO_PANEL_HEIGHT 400U
...
#error Currently only support FLEXIO MCULCD SMARTDMA
       ...
       (DEMO_PANEL_RK055MHD091 == DEMO_PANEL) || (DMB_DISPLAY))
